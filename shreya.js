...
Array.from(document.getElementsByClassName('hi')).forEach((e)=>{
    e.addEventListener('click',(element)=>{
        ...
        let songTittles2 = shreya.filter((els) =>{
            return els.id == index;
        })
...
const shreya = [
    {
        ...
        <div class="Name">Shreya Ghoshal, Ganesh Chandanshive, Mujtaba Aziz Na`,
        poster: "img/img111.jpg",

    },
    {
        id:112,
        songName: `Mohe Rang Do Laal
        <div class="Name">Pandit Birju Maharaj, Shreya Ghoshal, & Siddharth Gari</div>`,
        poster: "img/img111.jpg",
    ...
    },
    {
        id:113,
        songName: `Tere Bina
        <div class="Name">A.R. Rahman, Shreya Ghoshal</div>`,
        poster: "img/img113.jpg",

    },
    {
        id:114,
        songName: `Manwa Laage
        <div class="Name">Shreya Ghoshal, Arjit Singh, Vishal-Shekhar</div>`,
        poster: "img/img114.jpg",
    ...
    },
    {
        ...
        poster: "img/img115.jpg",

    },
    {
        id:116,
        songName: `Love Mashup
        <div class="Name">Shekhar Ravjiani, Shilpa Rao, Aakanksha Sharma, Shreya Ghoshal</div>`,
        poster: "img/img116.jpg",
...

    {
        ...
        <div class="Name">Ajay-Atul, Shreya Ghoshal</div>`,
        poster: "img/img118.jpg",
...

    {
        id:119,
        songName: `Dil Dooba
        <div class="Name">Sonu Nigam, Shreya Ghoshal</div>`,
        poster: "img/img119.jpg",
...

    {
        ...
        <div class="Name">KK, Shreya Ghoshal</div>`,
        poster: "img/img120.jpg",

    },

    {
        id:121,
        songName: `Ek Haseena Thi
        <div class="Name">Shreya Ghoshal, Himesh Reshammiya</div>`,
        poster: "img/img121.jpg",
...

    {
        ...
        <div class="Name">Shreya Ghoshal, Tony Kakkar</div>`,
        poster: "img/img122.jpg",

    },

    {
        id:123,
        songName: `Do Anjaane Ajnabi
        <div class="Name">Shreya Ghosal, Udit Narayan</div>`,
        poster: "img/img123.jpg",
...

    {
        id:124,
        songName: `Tere Liye
        <div class="Name">Shreya Ghoshal, Atif Aslam</div>`,
        poster: "img/img124.jpg",
...

    {
        id:125,
        songName: `Ve Kamleya
        <div class="Name">Shreya Ghosal, Pritam, Arijit Singh</div>`,
        poster: "img/img125.jpg",
...
Array.from(document.getElementsByClassName('art_songs')).forEach((e,i) =>{
    e.getElementsByTagName('h5')[0].innerHTML = shreya[i].songName;
    e.getElementsByTagName('img')[0].src = shreya[i].poster;
